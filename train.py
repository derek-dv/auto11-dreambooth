...
def train(url: str, model_name: str = "Test", is_new_model: bool = True, class_prompt="", instance_propmpt="", scheduler: str = "DEISMultistep", src_model: str = "/workspace/stable-diffusion-webui/models/Stable-diffusion/rose_del_me/rose_del_me_1800.safetensors"):
    # Create model
    if is_new_model:
        ...
        config["concepts_list"][0]["instance_data_dir"] = f"dataset{model_name}"
        config["concepts_list"][0]["instance_prompt"] = instance_propmpt
